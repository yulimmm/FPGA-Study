...
## Pmod Header JA
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { motor_l[3] }];  #IO_L14P_T2_SRCC_34 Sch=ja[1]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { motor_l[2] }];  #IO_L14N_T2_SRCC_34 Sch=ja[2]
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { motor_l[1] }];  #IO_L13P_T2_MRCC_34 Sch=ja[3]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { motor_l[0] }];  #IO_L11N_T1_SRCC_34 Sch=ja[4]
set_property -dict { PACKAGE_PIN H3    IOSTANDARD LVCMOS33 } [get_ports { motor_r[3] }];  #IO_L13N_T2_MRCC_34 Sch=ja[7]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { motor_r[2] }];  #IO_L12P_T1_MRCC_34 Sch=ja[8]
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports { motor_r[1] }];  #IO_L12N_T1_MRCC_34 Sch=ja[9]
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { motor_r[0] }];  #IO_L11P_T1_SRCC_34 Sch=ja[10]
...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { dip_sw[0]  }]; #IO_L11P_T1_SRCC_14 Sch=pio[16]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { dip_sw[1]  }]; #IO_L11N_T1_SRCC_14 Sch=pio[17]
...
#set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { dip_sw[0] }]; #IO_L10P_T1_D14_14 Sch=pio[20]
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { dip_sw[1] }]; #IO_L9N_T1_DQS_D13_14 Sch=pio[21]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { dip_sw[2] }]; #IO_L9P_T1_DQS_14 Sch=pio[22]
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { dip_sw[3] }]; #IO_L4N_T0_D05_14 Sch=pio[23]
