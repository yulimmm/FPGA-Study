...
## Pmod Header JA
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[7] }];  #IO_L14P_T2_SRCC_34 Sch=ja[1]
set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[6] }];  #IO_L14N_T2_SRCC_34 Sch=ja[2]
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[5] }];  #IO_L13P_T2_MRCC_34 Sch=ja[3]
set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[4] }];  #IO_L11N_T1_SRCC_34 Sch=ja[4]
set_property -dict { PACKAGE_PIN H3    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[3] }];  #IO_L13N_T2_MRCC_34 Sch=ja[7]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[2] }];  #IO_L12P_T1_MRCC_34 Sch=ja[8]
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[1] }];  #IO_L12N_T1_MRCC_34 Sch=ja[9]
set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 }  [get_ports { motor_data[0] }];  #IO_L11P_T1_SRCC_34 Sch=ja[10]
