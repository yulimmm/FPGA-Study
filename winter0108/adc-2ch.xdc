...
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { sel }]; #IO_L11P_T1_SRCC_14 Sch=pio[16] //sel을 DIP스위치 8번으로 설정
...
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { sel }]; #IO_L4N_T0_D05_14 Sch=pio[23]
